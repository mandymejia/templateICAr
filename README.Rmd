...
Depending on the analysis, PARDISO may reduce computation time. To obtain an 
INLA-PARDISO license, run `inla.pardiso()` in R after running `library(INLA)`. 
Once you obtain a license, point to it using 
